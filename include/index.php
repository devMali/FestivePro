...
<?php	
		...
		$run_cats=mysqli_query($con,$get_cats);
			while($row_cats=mysqli_fetch_array($run_cats))
			{
				...
				<div class='cat'>Click here for Makarsankranti Products</div></a>";
				
				echo "<a href='products.php?Cat=2'>
				<img src='include/holi.jpg' class='imcat' title='Holi' />
				<div class='cat'>Click here for Holi Products</div></a>";
				
				echo "<a href='products.php?Cat=3'>
				<img src='include/Navratri.jpg' class='imcat' title='Navratri' />
				<div class='cat'>Click here for Navratri Products</div></a>";
				
				echo "<a href='products.php?Cat=4'>
				<img src='include/fireworks.jpg' class='imcat' title='Diwali' />
				<div class='cat'>Click here for Diwali Products</div></a>";
