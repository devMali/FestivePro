...
<center><h3 style="color:#333333">Edit Unit:</h3></center><br>
							<div class="panel-title">
<?php
	$id=$_GET["x"];
	$db=mysqli_query($con,"select * from unit where unit_id='$id'");
	$rc=mysqli_num_rows($db);
	$row=mysqli_fetch_array($db);
?>

<div align="center">
<form action="unit_update" method="post">
<table>
	<tr>
		<td> Unit: </td>
		<input type="hidden" name="r0" value='<?php echo $row["unit_id"];?>' />
		<td>	<input type="text" name="r1" value='<?php echo $row["unit_name"];?>' />	</td>
	</tr>
	<tr>
		<td colspan="2"> <input type="submit" name="submit" value="Update" /> 
		<a href="unit.php"><input type="button" value="Cancel" /></a></td>
	</tr>
</table>
</form>
