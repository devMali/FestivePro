...
<center><h3 style="color:#333333">Update City:</h3></center><br>
							<div class="panel-title">
<?php
	$id=$_GET["x"];
	$db=mysqli_query($con,"select * from city where city_id='$id'");
...
<table>
	<tr>
		<td> City: </td>
		<input type="hidden" name="r0" value='<?php echo $row["city_id"];?>' />
		<td>	<input type="text" name="r1" value='<?php echo $row["city_name"];?>' />	</td>
	</tr>
	<tr>
		<td colspan="2"> <input type="submit" name="submit" value="Update" /> 
		<a href="city.php"><input type="button" value="Cancel" /></a></td>
	</tr>
</table>
</form>
